...
- Develop and maintain Support Center docs, API reference guides, and release notes.
- Participated in user testing of HDFC PayZapp 2.0 and gave feedback to improve usability.
- Collaborated with the UI/UX teams and customized content for India and the US for Support Center docs.
- Create and maintain comprehensive docs for Rewards Center from scratch.
- Interview developers, solution architects, and product managers to source information.
- Edit and proofread documentation for clarity, consistency, and adherence to MSTP guidelines.
...
- Sourced information from business analysts and developers and conducted review meetings.
- Attended scrum meets and scrum of scrum meets and discussed pain points to meet doc deadlines.
...
- Closely worked with the SEO team to evolve a strategy.
...
- Held independent in-charge of Hyderabad, Nizamabad, and Warangal editions.
